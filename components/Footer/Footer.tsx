          ...
          <section className="flex flex-col md:flex-row gap-8 md:gap-2 pb-8 lg:gap-0  items-start justify-between">
            ...
            <div className="max-w-[463px]">
              <div className="text-white">
                <h1 className=" mb-4">CONSUMER ADVISORY</h1>
                <div className="  space-y-4 border-r border-[#5D6544] pr-4 ">
                ...
                <p className="text-white pr-4 mt-8">
            ...
            <div>
              ...
              <div className="space-y-4 text-white">
                ...
                <p className="text-[#ABABAB]  !mt-[55px]">
